...
export default {
  ...
  argTypes: {
    ...
    variant: {
      control: {
        type: 'select',
        options: [null, 'contained', 'outlined', 'iconOnly'],
      },
    },
  },
} as Meta;
...
export const ButtonStory: FC = () => (
  <Container>
    ...
    <span style={{ color: 'red' }}>
      Warning: No color buttons must be used inside another button or modified
      on-the-fly to look like buttons
    </span>
  ...
  <Container>
    ...
    {args.buttonType === 'IconButton' ? (
      ...
      <Button
        ...
        variant={args.variant}
        startIcon={
          args.withStartIcon ? <CheckCircleOutlineOutlinedIcon /> : null
        }
